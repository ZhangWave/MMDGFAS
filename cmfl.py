...
#         print("inputs_a shape:", inputs_a.shape)
#         print("inputs_a values (first 5):", inputs_a[:10])
        
#         print("inputs_b shape:", inputs_b.shape)
#         print("inputs_b values (first 5):", inputs_b[:5])

#        # 打印targets的形状和部分值
#         print("targets shape:", targets.shape)
#         print("targets values (first 5):", targets[:5])

        # bce_loss_a = F.binary_cross_entropy(inputs_a, targets, reduce=False)
        bce_loss_a = F.binary_cross_entropy(inputs_a.float(), targets.float(), reduction='none')
        # bce_loss_b = F.binary_cross_entropy(inputs_b, targets, reduce=False)
        bce_loss_b = F.binary_cross_entropy(inputs_b.float(), targets.float(), reduction='none')
